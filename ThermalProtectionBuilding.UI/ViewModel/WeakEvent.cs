...
{
    /// <summary>
    /// Умное слабое событие (т. е. не обязательно отписываться от события, чтобы сборщик мусора уничтожил подписчиков)
	...
	internal sealed class WeakEvent<T> where T : class
    {
        static WeakEvent()
        {
...
#pragma warning restore 420
    ...
    /// </summary>
    internal static class FastSmartWeakEventRaiseExtensions
    {
